    ...
    <section id="clubs" className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="text-center mb-12">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-3xl md:text-4xl font-black font-serif text-gold-gradient mb-3"
        >
          {t('clubs.title')}
        </motion.h2>
        <motion.p
        ...
        >
          {groups.map((group, index) => {
            ...
            return (
              ...
              >
                <div className="rounded-2xl bg-card-bg border border-card-border overflow-hidden hover:border-rose-gold/40 transition-all duration-300 h-full group cursor-pointer" onClick={() => handleBrowse(name)}>
                  {/* Card image hero */}
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    <button
                      ...
                      className="w-full py-2 rounded-xl bg-gradient-to-r from-rose-gold/10 to-dusty-pink/10 hover:from-rose-gold/20 hover:to-dusty-pink/20 border border-rose-gold/20 text-xs font-semibold text-rose-gold transition-all flex items-center justify-center gap-1 cursor-pointer"
                    >
                      {t('clubs.view_hosts')}
      ...
      <div className="text-center mt-10">
        <a
          href="/clubs"
          className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-gradient-to-r from-rose-gold/10 to-dusty-pink/10 hover:from-rose-gold/20 hover:to-dusty-pink/20 border border-rose-gold/20 text-sm font-semibold text-rose-gold transition-all"
        >
